...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:GALIH GANZ\n' 
            + 'ORG: Pengembang BOT;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6289530863358:+62 895-3086-3358\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 30
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6289530863358@s.whatsapp.net"] 
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.subscribe','white'),color('YOU','red'),color('TUBE','white'),color('GALIH BOT','yellow'))
})
            ...
            case 'bitly':
               ...
               case 'help': 
         	   ...
         	   case 'creator':
                  ...
                  client.sendMessage(from, 'OWNER FDL GANZ AMJAY :v',MessageType.text, { quoted: mek} )
					break    
				case 'leaderboard':
				case 'lb':
